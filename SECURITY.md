...
- affected tool, crate, feature, or workflow;
...
Security fixes normally land through pull requests with required hosted checks.
For urgent, validated high-impact issues, maintainers may use a narrow
break-glass path, then record a sanitized remediation receipt.
